...
# Allow all origins for Cross-Origin Resource Sharing (CORS)- used in caaes of port mismatch
origins = ["*"]
...
async def index(request: Request):
    ...
    return templates.TemplateResponse(
        request=request, 
        name="index.html", 
        context={"status": "Rendering"} # keeping your status string safe
    )   
# async def index(request: Request):
#     """
#     Renders the main HTML form page for vehicle data input.
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        #VehiceData class is used to convert form data into a DataFrame for the model
        ...
        # Make a prediction and retrieve the result ie 1 or 0
