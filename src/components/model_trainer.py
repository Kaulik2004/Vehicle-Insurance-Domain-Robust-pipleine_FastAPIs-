...
class ModelTrainer:
    def __init__(self, data_transformation_artifact: DataTransformationArtifact,
        ...
        # self.metric_report_file_path = metric_report_file_path
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            # logging.info("Saving metric report to file.")
            #     # metric_report_file_path=
            # with open(self.metric_report_file_path, 'w') as f:
            #     f.write(f"F1 Score: {metric_artifact.f1_score}\n")
            #     f.write(f"Precision Score: {metric_artifact.precision_score}\n")
            #     f.write(f"Recall Score: {metric_artifact.recall_score}\n")
            #     json.dump(metric_artifact.to_dict(), f, indent=4)
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            #object saved as model.pkl in the model_trainer_config.trained_model_file_path 
            # ie model.pkl is saved in artifacts/model_trainer/model.pkl
            save_object(self.model_trainer_config.trained_model_file_path, my_model)
            logging.info("Saved final model object that includes both preprocessing and the trained model")

            #saving the metric report
