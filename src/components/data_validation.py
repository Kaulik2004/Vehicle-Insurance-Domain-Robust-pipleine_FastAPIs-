...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            validation_status = len(validation_error_msg) == 0 # if it is 0 that means there is no error and validation is 
            #                                                  successful else it is not successful. 0 returns True and >0 returns False
            ...
            #report added in the data_validation_artifact to the JSON file via data_validation_config.validation_report_file_path
