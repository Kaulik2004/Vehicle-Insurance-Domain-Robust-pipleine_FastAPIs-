...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[Proj1Estimator]:
        ...
        try:
            ...
            #returns None if model is not present in s3 storage and returns Proj1Estimator object if model is present in s3 storage
            return None
        except Exception as e:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        """
        try:
            #we take the oro9ignal test not the transformed test data because we will transform the test data in this function to evaluate the model
            ...
            #retrived f1 score for trained model on test data
